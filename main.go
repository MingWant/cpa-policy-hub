...
<section id="keys" class="view split"><div class="card"><div class="bar"><div><h2>API Keys</h2><div class="muted">Imported CPA keys can be overridden here. Only a masked fingerprint is shown; full key material is never shown.</div></div><button onclick="loadKeys()">Refresh</button></div><div style="overflow:auto"><table><thead><tr><th>Name</th><th>Fingerprint</th><th>ID</th><th>Source</th><th>Limits</th><th>Policy</th><th>Usage</th><th></th></tr></thead><tbody id="keyRows"><tr><td colspan="8" class="muted">Connect first.</td></tr></tbody></table></div></div>
